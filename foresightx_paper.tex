...
\begin{table}[t]
\centering
\caption{Full Model Comparison --- Bengaluru Urban Dataset (Feb--Aug 2024, identical test window). Best per metric in bold.}
\label{tab:full}
...
\begin{figure*}[t]
\centering
\begin{subfigure}{0.30\textwidth}\includegraphics[width=\linewidth]{mae.png}\caption{MAE}\end{subfigure}\hfill
\begin{subfigure}{0.30\textwidth}\includegraphics[width=\linewidth]{mape.png}\caption{MAPE}\end{subfigure}\hfill
\begin{subfigure}{0.30\textwidth}\includegraphics[width=\linewidth]{rmse.png}\caption{RMSE}\end{subfigure}

\vspace{2mm}
\begin{subfigure}{0.30\textwidth}\includegraphics[width=\linewidth]{nrmse.png}\caption{NRMSE}\end{subfigure}\hfill
\begin{subfigure}{0.30\textwidth}\includegraphics[width=\linewidth]{ups.png}\caption{UPS}\end{subfigure}\hfill
...
\bibitem{ref6} ``Temporal Fusion Transformer for Real-Time Intersection Turning Movement Flow Forecasting Incorporating Exogenous Factors,'' \textit{IEEE Conf. Publication}, 2024. [Online]. Available: https://ieeexplore.ieee.org/document/10919975/
\bibitem{ref7} ``Electricity Load Forecasting Using Attention-Based Hybrid Deep Learning Model (CNN-BiLSTM),'' \textit{IEEE Conf. Publication}, 2024. [Online]. Available: https://ieeexplore.ieee.org/document/10729950/
\bibitem{ref8} ``Advancing Power Load Forecasting Framework with CNN-GRU-BiLSTM,'' \textit{IEEE Conf. Publication}, 2024. [Online]. Available: https://ieeexplore.ieee.org/document/10698376/
...
\bibitem{ref13} ``Novel Confined Attention-Enabled Hierarchical Bi-LSTM and Bi-GRU Fusion: A Multiscale Traffic Flow Prediction Application,'' \textit{IEEE Journals \& Magazine}, 2024. [Online]. Available: https://ieeexplore.ieee.org/document/10555153/
\bibitem{ref14} ``Highway Traffic Parameter Prediction Model Based on the Combined Deep Learning Model (ICSSA-GRU-ATT),'' \textit{IEEE Conf. Publication}, 2024. [Online]. Available: https://ieeexplore.ieee.org/document/10498388/
\bibitem{ref15} ``Temporal Fusion Transformer with Non-Intrusive Attention for Data-Driven Electricity Load Forecasting,'' \textit{IEEE Conf. Publication}, 2024. [Online]. Available: https://ieeexplore.ieee.org/document/10453838/
...
\bibitem{ref17} ``AirTFT: A Novel Transformer-Based Approach for Air Quality Prediction,'' \textit{IEEE Conf. Publication}, 2024. [Online]. Available: https://ieeexplore.ieee.org/document/10898497/
...
\bibitem{ref21} ``Research on Air Quality Prediction Based on LSTM-Transformer with Adaptive Temporal Attention Mechanism,'' \textit{IEEE Conf. Publication}, 2024. [Online]. Available: https://ieeexplore.ieee.org/document/10417651/
\bibitem{ref22} ``Attention-Based CNN-LSTM and XGBoost Hybrid Model for Air Quality Prediction,'' \textit{IEEE Conf. Publication}, 2024. [Online]. Available: https://ieeexplore.ieee.org/document/10695634/
\bibitem{ref23} ``A Resource-Aware Multi-Graph Neural Network for Urban Traffic Flow Prediction in Multi-Access Edge Computing Systems,'' \textit{IEEE Journals \& Magazine}, 2024. [Online]. Available: https://ieeexplore.ieee.org/document/10628098/
\end{thebibliography}
